export default class Matrix4x4 {
	...
	public frustum(
		...
		frust.elements[0 * 4 + 1] =
			frust.elements[0 * 4 + 2] =
			frust.elements[0 * 4 + 3] =
				0.0;
		frust.elements[1 * 4 + 1] = (2.0 * nearZ) / deltaY;
		frust.elements[1 * 4 + 0] =
			frust.elements[1 * 4 + 2] =
			frust.elements[1 * 4 + 3] =
				0.0;
		...
		frust.elements[3 * 4 + 0] =
			frust.elements[3 * 4 + 1] =
			frust.elements[3 * 4 + 3] =
				0.0;
	...
	public multiply(right: Matrix4x4) {
